...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NUM");
    case mBTC: return QString("mNUM");
    case uBTC: return QString::fromUtf8("μNUM");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("NUMIVs"));
    case mBTC: return QString(QObject::tr("Milli-NUMIVs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-NUMIVs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
